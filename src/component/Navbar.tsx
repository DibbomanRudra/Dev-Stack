          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="flex items-center lg:hidden">
              ...
              >
                <div className="w-5 h-3.5 flex flex-col justify-between select-none relative">
                  <span
                    className={`w-full h-0.5 bg-slate-800 rounded-full block transition-transform ${
                      isMobileMenuOpen ? "rotate-45 translate-y-[6px]" : ""
                    }`}
                  />

                  <span
                    className={`w-full h-0.5 bg-slate-800 rounded-full block transition-opacity ${
            ...
            <div className="flex items-center gap-2 select-none">
              ...
              <span className="text-xl sm:text-2xl font-black tracking-tight text-slate-900">
                Dev
                <span className="text-brand-gradient">Stack</span>
              </span>
            </div>
          </div>
